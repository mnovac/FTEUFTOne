Dim iURL @@ script infofile_;_ZIP::ssf42.xml_;_
Dim objShell
iURL = Parameter("url")
...
Browser("Login -_2").Page("Login -").WebButton("SIGN IN").Click
'Browser("Login -").Page("Login -").WebButton("SIGN IN").Click @@ script infofile_;_ZIP::ssf41.xml_;_
End If
