...
WpfWindow("Micro Focus MyFlight Sample").WpfEdit("agentName").Set DataTable("User_Name") @@ hightlight id_;_2113647904_;_script infofile_;_ZIP::ssf9.xml_;_
WpfWindow("Micro Focus MyFlight Sample").WpfEdit("password").SetSecure DataTable("Password") @@ hightlight id_;_2092967184_;_script infofile_;_ZIP::ssf11.xml_;_
...
WpfWindow("OpenText MyFlight Sample").WpfEdit("agentName").Set DataTable("User_Name") @@ hightlight id_;_1879592408_;_script infofile_;_ZIP::ssf26.xml_;_
WpfWindow("OpenText MyFlight Sample").WpfEdit("password").SetSecure DataTable("Password") @@ hightlight id_;_1925331352_;_script infofile_;_ZIP::ssf27.xml_;_
